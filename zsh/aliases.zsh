...
alias tasf='tmux list-session | awk -F'"'"':'"'"' '"'"'{printf $1}'"'"' | fzf --print0 --select-1 --exit-0 | xargs -0 -o -t tmux attach-session -t'
alias tls='tmux list-session'
alias tks='tmux kill-session -t'
alias tksf='tmux list-session | awk -F'"'"':'"'"' '"'"'{printf $1}'"'"' | fzf --print0 --select-1 --exit-0 | xargs -0 -o -t tmux kill-session -t'
